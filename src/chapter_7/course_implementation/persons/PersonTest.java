package chapter_7.course_implementation.persons;
...
import chapter_7.course_implementation.filters.*;
...
public class PersonTest {
	...
	@Test public void getTotalFor_LegalCase() throws Exception {
			...
			assertEquals(BigInteger.valueOf(1500), thePerson.getTotalFor(theExtractor));
	}
